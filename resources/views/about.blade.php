...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="page-title-heading center">
                        ...
                        <div class="title-inner link-style-3">
                            <h5 class=""><a class="home fw-4" href="/">Trang Chủ</a><span>Giới Thiệu</span></h5>
                        </div>
                    </div>                        
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">                  
                <div class="col-lg-6 col-md-7">
                    <div class="wrap-about">
                        <div class="heading-section">
                            ...
                            <h2>Chất Lượng, Đảm Bảo An Toàn Và Tin Cậy</h2>
                        ...
                        <div class="box-icon flex">
                            ...
                            <div class="content">
                                <h3 class="link-style-1"><a href="#">Chất lượng Tinh Tế</a></h3>
                        ...
                        <div class="box-icon flex">
                            ...
                            <div class="content">
                                <h3 class="link-style-1"><a href="#">An Toàn và Tin Cậy</a> </h3>
                ...
                <div class="col-lg-6 col-md-5">
                    <div class="wrap-img relative center">
                        <div class="images image-1">
                            <img src="assets/images/blog/blog-2.jpg" alt="images" style="height: 100%;scale:1.3">
                        </div>
                        <div class="images image-2">
                            <img src="assets/images/img-box/about-1.jpg" alt="images" style="height: 100%;scale:1.1">
                        </div>
                        <div class="mark-image">
                            <img src="assets/images/mark/mark-about.png" alt="images">
                        </div>                   
                    </div>
                </div>
            </div>
    ...
    <section class="tf-section flat-icon" style='background:#f3f6f0'>
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="box-icon" style='background:white; height:100%'>
                        <div class="icon">
